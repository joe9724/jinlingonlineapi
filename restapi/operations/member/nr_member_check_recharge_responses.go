...
func (o *MemberCheckRechargeOK) WithPayload(payload *models.InlineResponse200) *MemberCheckRechargeOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the member check recharge o k response
func (o *MemberCheckRechargeOK) SetPayload(payload *models.InlineResponse200) {
	o.Payload = payload
}
