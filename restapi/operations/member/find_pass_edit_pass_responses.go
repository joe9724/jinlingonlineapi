...
func (o *FindPassEditPassOK) WithPayload(payload *models.InlineResponse200) *FindPassEditPassOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the find pass edit pass o k response
func (o *FindPassEditPassOK) SetPayload(payload *models.InlineResponse200) {
	o.Payload = payload
}
