...
func (o *MemberRegisterSendSmsOK) WithPayload(payload *models.InlineResponse200) *MemberRegisterSendSmsOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the member register send sms o k response
func (o *MemberRegisterSendSmsOK) SetPayload(payload *models.InlineResponse200) {
	o.Payload = payload
}
