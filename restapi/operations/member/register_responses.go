...
func (o *RegisterOK) WithPayload(payload *models.InlineResponse200) *RegisterOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the register o k response
func (o *RegisterOK) SetPayload(payload *models.InlineResponse200) {
	o.Payload = payload
}
